...
public struct Day {
     ...
     */
    public func date(with time: Time, in timeZone: TimeZone) -> Date {
     ...
     */
    public func dateRange(in timeZone: TimeZone) -> Range<Date> {
     ...
     */
    public func timeInterval(since day: Day, in timeZone: TimeZone) -> TimeInterval {
     ...
     */
    public func timeInterval(since dayTime: DayTime, in timeZone: TimeZone) -> TimeInterval {
     ...
     */
    public func numberOfDays(since day: Day, in timeZone: TimeZone) -> Int {
     ...
     */
    public func date(withTimeFrom date: Date, in timeZone: TimeZone) -> Date {
     ...
     */
    public static func + (lhs: Day, timeInterval: TimeInterval) -> Day {
